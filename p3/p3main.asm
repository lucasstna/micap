...
;--------------------------------------------------------
	.area BSEG    (BIT)
Lp3main.int_serial$sloc0$1$0==.
_int_serial_sloc0_1_0:
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
;rpm                       Allocated to registers r4 r5 r6 r7 
;------------------------------------------------------------
	G$int_serial$0$0 ==.
	C$p3main.c$113$1$40 ==.
...
00123$:
	...
	reti
;------------------------------------------------------------
;Allocation info for local variables in function 'mostra_menu'
;------------------------------------------------------------
	G$mostra_menu$0$0 ==.
	C$p3main.c$221$1$42 ==.
...
;	Z:\9semestre\micap\micap-master-ultimo\micap-master\p3\p3main.c:288: SPIF = 0;
	clr	_SPIF
	C$p3main.c$289$1$54 ==.
;	Z:\9semestre\micap\micap-master-ultimo\micap-master\p3\p3main.c:289: while(!SPIF); // espera o t�rmino do deslocamento do �ltimo valor
00113$:
	C$p3main.c$290$1$54 ==.
...
;	Z:\9semestre\micap\micap-master-ultimo\micap-master\p3\p3main.c:310: SPIF = 0;
	clr	_SPIF
	C$p3main.c$311$1$56 ==.
;	Z:\9semestre\micap\micap-master-ultimo\micap-master\p3\p3main.c:311: while(!SPIF); // espera o t�rmino do deslocamento do �ltimo valor
00113$:
	C$p3main.c$312$1$56 ==.
